"""
Alternate tensorflow implementation of quasi-recurrent layer.

Reference: https://arxiv.org/pdf/1611.01576.pdf
This one is object-oriented and uses the 'tf.nn.rnn_cell.RNNCell' class
for the recurrent calculation.
"""
...
class QRLayer:
    ...
    def __call__(self, inputs):
        ...
        pool = _QRPool(self._n_units, self._pool_type)
...
class _QRPool(tf.nn.rnn_cell.RNNCell):
